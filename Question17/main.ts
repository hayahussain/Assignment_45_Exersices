...
let guestName:string[] = ["Zohan", "Azlan", "Ali", "Zoha", "Kishwer", "Saif"]
console.log("Sorry Guyz bad news, my new dinner table won't arrive so i'm invite only two guest");

// Remove guest

while (guestName.length > 2){
    let removedGuest:string | undefined = guestName.pop();

console.log(`Dear ${removedGuest}, sorry you can't invite to dinner`);
}
